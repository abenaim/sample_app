...
describe User do
  ...
  describe "micropost associations" do
    ...
    it "should avoir un attribut `microposts`" do
      @user.should respond_to(:microposts)
    end

    it "should avoir les bons micro-messags dans le bon ordre" do
      @user.microposts.should == [@mp2, @mp1]
    end

    it "should detruire les micro-messages associes" do
      @user.destroy
    ...
    describe "Etat de l alimentation" do
      ...
      it "should avoir une methode `feed`" do
        @user.should respond_to(:feed)
      end

      it "should inclure les micro-messages de l utilisateur" do
        #permet de verifier si il existe un element dans un tableau ex : a = [1, "foo", :bar]  >> a.include?("foo") => true
        @user.feed.include?(@mp1).should be_true
        @user.feed.include?(@mp2).should be_true
      end

      it "should not inclure les micro-messages d un autre utilisateur" do
